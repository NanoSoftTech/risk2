...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" border="1">
                            <thead>
                <tr cor>
                    <th align="center" colspan="6" ><h2><i class="fa fa-files-o"></i>
                            รายงานความเสี่ยงประจำเดือน<br>
                            ระหว่างวันที่ <?php echo $func->format_date($_GET['date_start'])." ถึง ".$func->format_date($_GET['date_end']) ?>
                        </h2>
                    </th>
                </tr>
                                <tr>
