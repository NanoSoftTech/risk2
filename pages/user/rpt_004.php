        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานความเสี่ยงประจำเดือน หมวด
            <?php if(isset($_POST['date_start']) && isset($_POST['date_end'])){?>           
              <a href="rpt_004-print.php?date_start=<?php echo $_POST['date_start'];?>&date_end=<?php echo $_POST['date_end'];?>" 
...
<div class="row">
    <div class="col-lg-12"> 
<form action="?page=<?php echo sha1('rpt_004') ?>" method="post" name="frm" id="frm" autocomplete="off" enctype='multipart/form-data' >
                <div class="col-sm-4 ">
