...
<div class="row">
    <div class="col-lg-12">
                    ...
                    echo "<tr class= 'odd gradeX'>
                            ...
                            <td align='center'><a href='?page=".sha1('edit_risk')."&getid=$record[risk_id] '><i class='fa fa-wrench fa-fw'></i></a></td>
                            <td align='center'><a href='?page=".sha1('cancel_risk')."&getid=$record[risk_id] ' onclick='return checkDelete()'><i class='fa fa-trash-o fa-fw'></i></a></td>
                        </tr>";
                                }
                                ?>
                            </tbody>
