...
<?php
$sql_x = "select cat_id,cat_name from sys_category ";
...
while ($rec_x = mysql_fetch_array($res_x)){
    if($rec_x['cat_name'] != ""){
$text_x .= "'";
$text_x .= $rec_x['cat_name'];
$text_x .= "',";
$text_name[$num_x] = $rec_x['cat_name'];
$num_x++;
    }
}

for($n=1;$n<$num_x;$n++){
    $sql[$n] = "select cat_id from tb_risk where cat_id = '$n' ";
...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">กราฟรายงาน แยกหมวดความเสี่ยง </h1>
...
<div class="row">
    ...
    <div class="panel-body">
        <form action="?page=<?php echo sha1('rpt_007') ?>" method="post" name="frm" id="frm" autocomplete="off">
        <div class="col-sm-4 ">
