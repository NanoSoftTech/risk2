        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานความเสี่ยงประจำเดือน แยกสถานะ
            <?php if(isset($_POST['date_start']) && isset($_POST['date_end'])){?>           
              <a href="rpt_002-print.php?date_start=<?php echo $_POST['date_start'];?>&date_end=<?php echo $_POST['date_end'];?>" 
...
<div class="row">
    <div class="col-lg-12"> 
<form action="?page=<?php echo sha1('rpt_002') ?>" method="post" name="frm" id="frm" autocomplete="off" enctype='multipart/form-data' >
                <div class="col-sm-4 ">
            ...
            <?php if(isset($_POST['date_start']) && isset($_POST['date_end'])){?>
            <?php 
            $sqlA = "select sta_id,sta_name from sys_status_risk";
            $resA = mysql_query($sqlA)or die($sqlA);
            while ($recA = mysql_fetch_array($resA)){
            if($func->getRows("select risk_status from tb_risk where risk_status = '$recA[sta_id]' ") >0){
            ?>
<div class="row">
    <div class="col-lg-12"> 
        <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" >
                            <thead>
                                <tr><th align="center" colspan="6"><?php echo $recA['sta_name']; ?></th></tr>
                                <tr>
