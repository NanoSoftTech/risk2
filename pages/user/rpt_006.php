...
<?php
$sql_x = "select dep_id,dep_name from sys_department ";
...
while ($rec_x = mysql_fetch_array($res_x)){
    if($rec_x['dep_name'] != ""){
$text_x .= "'";
$text_x .= $rec_x['dep_name'];
$text_x .= "',";
$text_name[$num_x] = $rec_x['dep_name'];
$num_x++;
    }
}

for($n=1;$n<$num_x;$n++){
    $sql[$n] = "select dep_id from tb_risk where dep_id = '$n' ";
...
?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">กราฟรายงาน แยกฝ่าย
...
<div class="row">
    ...
    <div class="panel-body">
        <form action="?page=<?php echo sha1('rpt_006') ?>" method="post" name="frm" id="frm" autocomplete="off">
        <div class="col-sm-4 ">
